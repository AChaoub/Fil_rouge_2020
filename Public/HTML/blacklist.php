...
$sql_bl = " SELECT * FROM liste_noir , client, admin_locar where client.id_Utilisateur = liste_noir.id_Utilisateur And liste_noir.id_Admin = admin_locar.id_Admin And liste_noir.id_Admin =1";
$res_bl = mysqli_query($conn, $sql_bl);
$rows_bl = mysqli_num_rows($res_bl);
?>
...
<div class="container-custom cf-container-custom">
    ...
    <section class="NB_client-section">
        <div class="count_cl">
            <div class="count_cl_nbr"><?php echo $rows_bl . '&nbsp' ?></div> <!-- &nbsp espace-->
            <div class="count_cl_profil"> Blacklist Clients</div>
        </div>
    </section>
